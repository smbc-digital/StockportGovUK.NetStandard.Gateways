...
namespace StockportGovUK.NetStandard.Gateways.CivicaPay
{
    ...
    {
        private const string ApiRoot = "StockportEstoreTest/TransportableBasket/api";
        ...
        public CivicaPayTestGateway(HttpClient httpClient) : base(httpClient)
        {
        }

        private string EStoreRoot => $"{base.Client.BaseAddress}StockportEstoreTest";
