...
namespace StockportGovUK.NetStandard.Gateways.BookingServiceAdmin
{
    public interface IBookingServiceAdminGateway
    {
        ...
        Task<HttpResponseMessage> AddExport(Export request);
        Task<HttpResponseMessage> DeleteExport(Guid exportId);
        ...
        Task<HttpResponseMessage> UpdateUserLastLogin(BaseUserRequest request);
